...
public class CommentListHelper extends AsyncTask<Void, Void, String> {
    String response = "";
    Context context;
    Long totalBytes;
    String sessionid;
     ...
     */
    public CommentListHelper(AsyncResponder delegate, Context context, String sessionid){
    ...
    private void getComments() throws IOException {
        ...
        try {
            // URL of the backend.
            URL url = new URL("http://104.248.0.248/sessions/" + sessionid + "/comments");

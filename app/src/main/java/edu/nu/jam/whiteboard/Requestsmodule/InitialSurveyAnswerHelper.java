...
public class InitialSurveyAnswerHelper extends AsyncTask<Void, Void, String> {
    String response = "";
    Context context;
    Long totalBytes;
    String userId;
     ...
     */
    public InitialSurveyAnswerHelper(AsyncResponder delegate, Context context, String userId,
     ...
     * @throws IOException
     */
    private void getLearningStyleAnswers() throws IOException {
        HttpURLConnection connection = null;
        BufferedReader reader = null;

        try {
            // URL of the backend.
            URL url = new URL("http://104.248.0.248/students/" + userId);

...
public class CommentRepliesListHelper extends AsyncTask<Void, Void, String> {
    String response = "";
    Context context;
    Long totalBytes;
    String commentid;
     ...
     */
    public CommentRepliesListHelper(AsyncResponder delegate, Context context, String commentid){
    ...
    private void getComments() throws IOException {
        ...
        try {
            // URL of the backend.
            URL url = new URL("http://104.248.0.248/comments/" + commentid + "/replies");

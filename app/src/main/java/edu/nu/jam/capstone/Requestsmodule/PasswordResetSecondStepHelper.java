...
public class PasswordResetSecondStepHelper extends AsyncTask<Void, Void, String> {
    String response = "";
    String userid = "";
    String temppassword = "";
    String newpassword = "";
     ...
     * @param temppassword the temporary temporary password of the user.
     * @param newpassword the new new password of the user.
     */
    public PasswordResetSecondStepHelper(AsyncResponder delegate, Context context, String userid, String temppassword, String newpassword){
    ...
    private void resetPassword() throws IOException {
        ...
        try {
            ...
            jsonParam.put("tempPassword", temppassword);
